...
type Frequency = 'ANNUAL' | 'QUARTERLY' | 'MONTHLY' | 'WEEKLY' | 'ONE_OFF';
type ServiceStatus = 'DRAFT' | 'ACTIVE' | 'AWAITING_FILING' | 'READY_TO_CLOSE' | 'COMPLETE' | 'ARCHIVED';
      ...
      <div className="card-mdj">
        <div className="list-head">
          ...
          <div className="list-head-actions">
            ...
            <button 
              className={`segment ${status === 'DRAFT' ? 'active' : ''}`}
                      ...
                      <span
                        className={`badge ${
                          s.status === 'ACTIVE' || s.status === 'COMPLETE'
                            ? 'success'
                            : s.status === 'AWAITING_FILING' || s.status === 'READY_TO_CLOSE'
                            ? 'warn'
                            : 'default'
                        }`}
                      >
