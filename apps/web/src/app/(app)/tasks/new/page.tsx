...
export default function NewTaskPage() {
  ...
  useEffect(() => {
    ...
    const legacyClientServiceIdParam = searchParams.get('clientServiceId');
    const clientIdParam = searchParams.get('clientId');
    const preselectedServiceId = serviceIdParam || legacyClientServiceIdParam || undefined;

    if (title || description || priority || tags || preselectedServiceId || clientIdParam) {
      setFormData(prev => ({
        ...prev,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.clientId || !formData.serviceId || !formData.title) {
      setError('Client, related service, and title are required');
      return;
    }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                ...
                <div className="text-xs mt-2" style={{ color: 'var(--dim-light)' }}>
                  Tasks are tied to a client service period. Select the service period this task belongs to.
                </div>
              </div>
