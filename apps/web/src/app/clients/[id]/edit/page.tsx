  ...
  const handleSave = async () => {
    ...
    try {
      const payload: any = {
        ...
        feeArrangement: normalizeText(form.feeArrangement),
        businessBankName: normalizeText(form.businessBankName),
        accountLastFour: normalizeText(form.accountLastFour),
        directDebitInPlace: form.directDebitInPlace ?? false,
        paymentIssues: normalizeText(form.paymentIssues),
        ...
        <div style={{ display: 'grid', gap: '1rem' }}>
          ...
          <div className="card-mdj" style={{ padding: '1rem' }}>
            ...
            <div className="kv">
              ...
              <div className="v"><input className="input-mdj" value={form.engagementType || ''} onChange={(e) => setField('engagementType', e.target.value)} /></div>
              ...
              <div className="v"><input className="input-mdj" value={form.clientRiskRating || ''} onChange={(e) => setField('clientRiskRating', e.target.value)} /></div>
          ...
          <div className="card-mdj" style={{ padding: '1rem' }}>
            ...
            <div className="kv">
              ...
              <div className="v"><input className="input-mdj" value={form.preferredContactMethod || ''} onChange={(e) => setField('preferredContactMethod', e.target.value)} /></div>
          ...
          <div className="card-mdj" style={{ padding: '1rem' }}>
            <h3 style={{ marginTop: 0 }}>Tax & Registration</h3>
            <hr className="mdj-gold-divider" />
            <div className="kv">
              ...
              <div className="v"><input className="input-mdj" value={form.payrollFrequency || ''} onChange={(e) => setField('payrollFrequency', e.target.value)} /></div>
          ...
          <div className="card-mdj" style={{ padding: '1rem' }}>
            <h3 style={{ marginTop: 0 }}>Fees & Billing</h3>
            <hr className="mdj-gold-divider" />
            <div className="kv">
              <div className="k">Annual Fee</div>
              <div className="v"><input className="input-mdj" value={form.annualFee ?? ''} onChange={(e) => setField('annualFee', e.target.value === '' ? null : Number(e.target.value))} /></div>
              <div className="k">Monthly Fee</div>
              <div className="v"><input className="input-mdj" value={form.monthlyFee ?? ''} onChange={(e) => setField('monthlyFee', e.target.value === '' ? null : Number(e.target.value))} /></div>
              <div className="k">Fee Arrangement</div>
              <div className="v"><input className="input-mdj" value={form.feeArrangement || ''} onChange={(e) => setField('feeArrangement', e.target.value)} /></div>
              <div className="k">Business Bank</div>
              <div className="v"><input className="input-mdj" value={form.businessBankName || ''} onChange={(e) => setField('businessBankName', e.target.value)} /></div>
              <div className="k">Account Last 4</div>
              <div className="v"><input className="input-mdj" value={form.accountLastFour || ''} onChange={(e) => setField('accountLastFour', e.target.value)} /></div>
              <div className="k">Direct Debit</div>
              <div className="v"><input type="checkbox" checked={!!form.directDebitInPlace} onChange={(e) => setField('directDebitInPlace', e.target.checked)} /></div>
              <div className="k">Payment Issues</div>
              <div className="v"><input className="input-mdj" value={form.paymentIssues || ''} onChange={(e) => setField('paymentIssues', e.target.value)} /></div>
            </div>
          </div>

          <div className="card-mdj" style={{ padding: '1rem' }}>
            <h3 style={{ marginTop: 0 }}>Personal (Individual Clients)</h3>
            <hr className="mdj-gold-divider" />
            <div className="kv">
          ...
          <div className="card-mdj" style={{ padding: '1rem' }}>
            <h3 style={{ marginTop: 0 }}>Notes & Flags</h3>
            <hr className="mdj-gold-divider" />
            <div className="kv">
